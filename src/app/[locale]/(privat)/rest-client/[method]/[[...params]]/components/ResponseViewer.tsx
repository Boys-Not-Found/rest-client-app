'use client';
import { useRestStore } from '@/store/useRestStore.ts';
  ...
  return (
    <div className="mt-6 space-y-2">
      <div className="flex items-center gap-4">
        ...
        <div className="text-sm text-gray-800">{resp.statusText}</div>
      </div>

      <pre className="whitespace-pre-wrap text-black p-4 rounded text-sm">
